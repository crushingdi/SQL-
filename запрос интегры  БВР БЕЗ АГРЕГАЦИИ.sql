...
select distinct
	...
	,Case when isnull(DT2.DateTimeDelete, '') = '' then sum(DT2.HOLE_DEPTH) else 0 end AS Depth
...
where DT.DRILL_REC_IDENT in
	...
	,DT.DateTimeDelete
		...
		where T.Depth<>'0'  and T.EndTimeStamp<=@dateEnd -- and T.DrillBlockNumber='810-69' and EquipmentId= '1105'--and holeid='126'  --and T.DrillBlockNumber='850-117' --and holeid='086' 
