...
EquipmentId as Станок,
sum(Depth) as Глубина,
count(holeid) as Количество_скважин

--Case when isnull(DateTimeDelete, '') = '' then count(DateTimeDelete) else 0 end AS Count
